...
void Game::handle_events()
{
    ...
    while (SDL_PollEvent(&event))
    {
        ...
        default:
            ...
            EventSystem::event_handler(&event);
        }
    }
    //obsluga eventow z kolejki
    EventSystem::eventsHandling();
}
...
void Game::load(const std::string &def_file_path)
{
